...
### ReceiptFrag.java
    public class ReceiptFrag extends Fragment{
        ...
        private void initializeData(Context context) {
            ...
            Cursor cursor = db.rawQuery("select 交易編號, 匯款方, 收款方, 日期, 時間, 摘要, 金額, 留言 from 金流紀錄 where 匯款方 = " + "'" + userId + "' or 收款方 = " + "'" + userId + "' order by 日期 asc", null);
            int balance = 0;
            ...
            while (cursor.moveToNext()){
                ...
                receipts.add(new Receipt(
                        cursor.getString(0),
                        myDBHelper.getNameById(cursor.getString(1)),
                        myDBHelper.getNameById(cursor.getString(2)),
                        cursor.getString(3),
                        cursor.getString(4),
                        cursor.getString(5),
        ...
        public class ReceiptAdapter extends RecyclerView.Adapter<ReceiptAdapter.DataViewHolder>{
                    ...
                    cardView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (!receipt.getNo().equals("")) {
                                ...
                                txtReceiver.setText(myDBHelper.getNameById(receipt.getPayer()) + " (" + myDBHelper.getAccountById(receipt.getPayer()) + ")");
            ...
            public void onBindViewHolder(DataViewHolder dataViewHolder, int position) {
                ...
                if (receipts.get(position).getPayer().equals(username)) {
